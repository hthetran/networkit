...
constexpr node_t INVALID_NODE = 100000000;//std::numeric_limits<uint64_t>::max();
...
constexpr tradeid_t TRADELIST_END = 100000000;//std::numeric_limits<uint64_t>::max();
...
constexpr degree_t LISTROW_END = 100000000;//std::numeric_limits<uint64_t>::max();
